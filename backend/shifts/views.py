    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            try:
                ...
                # ✅ APLICAR FILTROS DE FECHA (sin restricción de 24 horas para vista)
                if start_date:
                    try:
                ...
                logger.info(f"📊 [MyShiftsAPIView] Total de turnos: {total_shifts}")
                
                # ✅ Construir respuesta SIN FILTRO DE 24 HORAS
                results = []
                for s in shifts_qs:
...
class EmployeeShiftsAPIView(APIView):
    ...
    def get(self, request, employee_id, *args, **kwargs):
        ...
        try:
            ...
            # ✅ AQUÍ SÍ aplicamos el filtro de 24 horas (para intercambios)
            try:
            ...
            logger.info(f"✅ Turnos válidos encontrados (>24h): {len(valid_shifts)}")
